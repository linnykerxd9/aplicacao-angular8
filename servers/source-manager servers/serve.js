...
var COURSES = [
    {
        ...
        description: 'Neste curso, os alunos irão obter  conhecimento inicial sobre o Angular ',
        duration: 120,
        code: 'XLF-1212',
        rating: 3,
        price: 12.99,
    ...
    },
    {
        ...
        description: 'Neste curso, os alunos irão obter um conhecimento aprofundado sobre os recursos disponíveis Angular.',
        duration: 80,
        code: 'DWQ-3412',
        rating: 3.5,
        price: 24.99,
    ...
    },
    {
        ...
        description: 'Neste curso, os alunos irão obter um conhecimento inicial ao .Net',
        duration: 80,
        code: 'QPL-0913',
        rating: 4.0,
        price: 36.99,
    ...
    },
    {
        ...
        description: 'Neste curso, os alunos irão obter um conhecimento aprofundado sobre os recursos disponíveis no .Net.',
        duration: 80,
        code: 'OHP-1095',
        rating: 4.5,
        price: 46.99,
    ...
    },
    {
        ...
        description: 'Neste curso, os alunos irão obter um conhecimento sobre lógica de programação',
        duration: 80,
        code: 'PWY-9381',
        rating: 5,
        price: 56.99,
